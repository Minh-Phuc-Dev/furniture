...
import OrderModal from "components/Orders/elements/OrderModal";
        ...
        "status",
        {
            ...
            cell: ({getValue}) => {
                ...
                return status === "PENDING" ? (
                    ...
                    <Badge type="intent" intent="error">Canceled</Badge>
                ) : status === "PROCESSING" ? (
                    <Badge type="outline" intent="secondary">Processing</Badge>
                ) : status === "COMPLETED" ? (
                    <Badge type="intent" intent="success">Completed</Badge>
                ) : null
            }
        }
    ),
    ...
    display(
        {
            ...
            cell: ({table, row}) => (
                <Modal.Root>
                    ...
                    <OrderModal table={table} row={row.original} index={row.index}/>
                </Modal.Root>
            )
        }
    )
